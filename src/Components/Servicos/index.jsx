...
const Servicos = () => {
  ...
  const servicos = {
    "Janelas em geral": {
      ...
      descricao:
        "O alumínio é um metal leve e resistente, o que faz com que a janela de alumínio possua boa durabilidade e resistência.",
      capa: JanelasCapa,
    },
    ...
    "Portas Pivoltantes": {
      ...
      descricao:
        "As portas de alumínio são a opção mais inovadora e prática para sua casa. Com design moderno e em vários modelos, elas são leves e muito fáceis de instalar e limpar.",
      capa: PortasCapa,
    },
    ...
    "Portas Deslizantes": {
      ...
      descricao:
        "Um guarda-corpo em alumínio e vidro é uma estrutura usada como proteção em locais elevados, a fim de evitar que haja queda para os níveis mais baixos.",
    ...
    "Portões em geral": {
      ...
      descricao:
        "O alumínio é um material resistente à corrosão e por isso garante ao portão ótima durabilidade. ",
      capa: PortaoCapa,
    },
  };
      ...
      <div className="container-galeria">
        ...
        <Row className="servicos">
          {Object.keys(servicos).map((tipo) => (
            <Col key={tipo} md={4} lg={3} className="mb-4 d-flex">
              <div className="w-100">
                <Card className="h-100">
                  <Card.Img
                    variant={tipo}
                    src={servicos[tipo].capa}
                    className="card-img-top"
                  />
                  <Card.Body className="d-flex flex-column justify-content-between">
                    <div>
                      <Card.Title>{tipo}</Card.Title>
                      <Card.Text className="text-card">{servicos[tipo].descricao}</Card.Text>
                    </div>
                    <Button
        ...
        <div className="slider-servicos-container">
